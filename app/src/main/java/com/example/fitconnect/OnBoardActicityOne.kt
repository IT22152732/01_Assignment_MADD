...
class OnBoardActicityOne : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_on_board_acticity_one)
        ...
        findViewById<android.widget.Button>(R.id.btnNext).setOnClickListener {
            startActivity(Intent(this, OnBoardActicityTwo::class.java))
        }
